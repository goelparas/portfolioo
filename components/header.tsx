...
const windowSize = useWindowSize();
  ...
  return (
    <header className="z-50 relative w-full  h-fit   items-center justify-center flex flex-col py-8 px-8">
            ...
            (windowSize.width < ScreenSize.MOBILE ? (
              ...
              <ul className="flex  flex-wrap items-center justify-center gap-y-1 text-[0.9rem] font-medium text-gray-500 sm:w-[initial] sm:flex-nowrap sm:gap-5">
                {links.map((link) => (
                  ...
                  >
                    <Link
                      className={cn("flex w-full items-center justify-center px-4 py-3  transition duration-150  text-orange ",{

...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        "z-10 flex w-20 h-20 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
    >
      {children}
...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="flex h-[500px] w-full items-center justify-center overflow-hidden rounded-lg p-10"
      ref={containerRef}
    >
      <div className="flex w-full flex-col items-stretch justify-between gap-10">
        ...
        <div className="flex flex-row items-center justify-between">
          ...
          <Circle ref={div4Ref} className="w-24 h-24">
            <Icons.openai />
          </Circle>
          <Circle ref={div6Ref}>
            <Icons.zapier />

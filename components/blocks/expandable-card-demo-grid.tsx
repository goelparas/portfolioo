      ...
      <ul className='flex  w-full gap-4'>
        {cards.map((card, index) => (
          <motion.div
            ...
            className='p-4 flex flex-col md:flex-row justify-between  w-full items-center min-w-fit hover:bg-neutral-50 dark:hover:bg-neutral-800 rounded-xl cursor-pointer'
          >
